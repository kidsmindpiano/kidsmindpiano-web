...
export default function LoginPage() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-primary/5 to-accent/5 py-16">
        ...
        <Card className="border-0 shadow-xl">
          <CardContent className="p-8">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <Button type="submit" className="w-full bg-primary hover:bg-primary/90 py-5">로그인</Button>
            </form>
