...
const reviews = [
  { name: "곽○○ 어머니", text: "아이가 처음에 피아노 어렵다고 하기 싫다 했는데 선생님도 한국선생님이라 너무 좋다고 하고 몇번해보더니 피아노 재밌다고 하네요. 연습도 매일 하라고 하면 곧잘 하구요 ❤️" },
  { name: "김○○ 어머니", text: "아이가 이번 레슨이 너무 재미있었나봐요 ㅋㅋ 자기가 만든 곡 동생한테 자랑하고 미소가 끊이질 않네요" },
  { name: "김○○ 어머니", text: "아이가 키즈마인드 하면서 피아노를 즐기면서 의욕적으로 하더니 곡도 만들고 멋지네요 🫶🏻 아이가 만든 곡을 선물로 받다니 ❤️ 정말 의미있는 선물이네요~~" },
  { name: "Grace 어머니", text: "오늘 너무 재밌었대요 ㅎ" },
  { name: "구○○ 어머니", text: "단기간에 뭔가 눈에띄는 성과보다는 최대한 흥미있게 배웠으면 좋겠네요!" },
  { name: "클레어 어머니", text: "아이가 수업을 재밌어 하네요. 감사합니다 😊 아이가 너무 부끄러웠다고 하네요 ☺️" },
