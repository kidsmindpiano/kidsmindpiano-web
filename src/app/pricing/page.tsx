...
const plans = [
  ...
  },
  {
    name: "집중반",
    price: "₩320,000",
    period: "월 8회 (주 2회 40분) / $240",
    features: ["주 2회 집중 레슨", "빠른 실력 향상", "매주 레슨 노트", "수업 영상 제공", "월별 학부모 상담"],
    cta: "등록 문의",
    popular: false,
  },
];
...
const faqs = [
  ...
  { q: "퍼스트레슨 후 바로 등록해야 하나요?", a: "아니요! 체험 후 충분히 생각하신 뒤 결정하시면 됩니다. 부담 없이 신청해주세요." },
