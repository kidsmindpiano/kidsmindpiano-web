              ...
              <CardContent className="p-8">
                ...
                <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-2 gap-4">
                    <div><Label htmlFor="parent">학부모 이름</Label><Input id="parent" placeholder="홍길동" className="mt-1.5" /></div>
                    <div><Label htmlFor="child">자녀 이름</Label><Input id="child" placeholder="홍길동" className="mt-1.5" /></div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div><Label htmlFor="age">자녀 나이</Label><Input id="age" placeholder="8세" className="mt-1.5" /></div>
                    <div><Label htmlFor="country">거주 국가</Label><Input id="country" placeholder="미국" className="mt-1.5" /></div>
                  </div>
